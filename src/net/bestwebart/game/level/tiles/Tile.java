...
public abstract class Tile {
	...
	public static final Tile WALL_RUIN = new WallRuin(10, Sprite.WALL_RUIN,
			false, -1, 3);
	...
	public static final Tile PLAYER_UP = new AnimatedTile(20, Sprite.PLAYER_UP,
			false, 120, 3);
	public static final Tile PLAYER_DOWN = new AnimatedTile(21,
			Sprite.PLAYER_DOWN, false, 120, 3);
	public static final Tile PLAYER_SIDE = new AnimatedTile(22,
			Sprite.PLAYER_SIDE, false, 120, 3);

	public static final Tile TONNY_UP = new AnimatedTile(23, Sprite.TONNY_UP,
			false, 120, 3);
	public static final Tile TONNY_DOWN = new AnimatedTile(24,
			Sprite.TONNY_DOWN, false, 120, 3);
	public static final Tile TONNY_SIDE = new AnimatedTile(25,
			Sprite.TONNY_SIDE, false, 120, 3);

	public static final Tile BAD_TONNY_UP = new AnimatedTile(26,
			Sprite.BAD_TONNY_UP, false, 120, 3);
	public static final Tile BAD_TONNY_DOWN = new AnimatedTile(27,
			Sprite.BAD_TONNY_DOWN, false, 120, 3);
	public static final Tile BAD_TONNY_SIDE = new AnimatedTile(28,
			Sprite.BAD_TONNY_SIDE, false, 120, 3);

	public static final Tile SIMPLE_PROJECTILE = new StaticTile(50,
			Sprite.SIMPLE_PROJECTILE);
	...
	public Tile(int id, Sprite sprite, boolean solid) {
		this.id = id;
		if (tiles[id] != null)
			throw new RuntimeException("Duplicated tile:" + this
					+ " at position:" + id);
		this.sprite = sprite;
		this.solid = solid;
		tiles[id] = this;
